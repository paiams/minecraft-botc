...
ssh -o BatchMode=yes -o ExitOnForwardFailure=yes -o ServerAliveInterval=15 -o ServerAliveCountMax=3 -R /home/mario/nginx-proxy-manager/data/botc/bridge.sock:127.0.0.1:8765 kbrp "chmod 600 /home/mario/nginx-proxy-manager/data/botc/bridge.sock; sleep infinity"
:failed
