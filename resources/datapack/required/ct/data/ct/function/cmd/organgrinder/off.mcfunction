...
tellraw @s [{"text":"! ","color":"yellow","bold":true},{"translate":"clocktower.role.organgrinder.name","color":"gray","bold":false},{"translate":"clocktower.notice.organgrinder.disabled_suffix","color":"red","bold":true}]
