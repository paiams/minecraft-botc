$execute if data storage ct:character_data characters.$(char).other run data modify storage ct:script night_order.other append value {id:$(char),other_night_key:"",localized:"no"}
