$execute if data storage ct:character_data characters.$(char).first run data modify storage ct:script night_order.first append value {id:$(char),first_night_key:"",localized:"no"}
